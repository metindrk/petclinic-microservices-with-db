...
APP_NAME="Petclinic"
ANS_KEYPAIR="mtn-$APP_NAME-dev-${BUILD_NUMBER}.key"
...
ansible-playbook -i ./ansible/inventory/dev_stack_dynamic_inventory_aws_ec2.yml ./ansible/playbooks/k8s_setup.yml
